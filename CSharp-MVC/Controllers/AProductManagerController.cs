...
{
    public class AProductManagerController : Controller
    {
        private readonly IProductService _productService;
        private readonly IProductCategoryService _productCategoryService;
        private readonly IProductInfoService _productInfoService;
        private readonly IUnityService _unityService;
        private readonly ILogger<AProductManagerController> _logger;
        public AProductManagerController(ILogger<AProductManagerController> logger, IProductService productService,
            IProductCategoryService productCategoryService, IProductInfoService productInfoService, IUnityService unityService)
        {
        ...
        [Route("AProductManager/GetPage/{id:int}")]
        ...
        [Route("AProductManager/Edit/{id:int}")]
        ...
        public async Task<IActionResult> EditProduct([FromForm] ProductAll request)
        {
            ...
            int idCategory = _productCategoryService.GetByProductCategoryName(Request.Form["Category"].ToString()).ProdCateID;
            string cate = Request.Form["Description"].ToString();
            var src = request.Picture;
            if (src == null)
                src = Request.Form["Picture"].ToString();
            if (!ModelState.IsValid)
            {
                var product = new Product
                {
        ...
        [Route("AProductManager/Delete/{id:int}")]
